...
function slideShowCycle(e) {
  if (
    (e.keyCode == "37" && document.location.href == "http://127.0.0.1:8080/") ||
    ...
    (document.location.href ==
      "https://sean-p040.github.io/index.html#footer" &&
      e.keyCode == "37") ||
    (document.location.href == "https://sean-p040.github.io/index.html#top" &&
      e.keyCode == "37") ||
    (document.location.href == "https://sean-p040.github.io/#top" &&
      e.keyCode == "37")
  ) {
    //left arrow key -> prev slide
    plusSlides(-1);
  } else if (
    (e.keyCode == "39" && document.location.href == "http://127.0.0.1:8080/") ||
    (document.location.href == "https://sean-p040.github.io/" &&
      e.keyCode == "39") ||
    (document.location.href == "https://sean-p040.github.io/index.html" &&
      e.keyCode == "39") ||
...
function calculateBMI() {
  ...
  if (valuesArray[0] == "" || valuesArray[1] == "") {
    ...
    result.innerHTML =
      "Your BMI is: " +
      (
        (parseFloat(valuesArray[1]) /
          parseFloat(valuesArray[0]) /
          parseFloat(valuesArray[0])) *
        703
      ).toFixed(2);
    const calculatedBMI = (
